...
exports.designTokens = exports.colorPalette = void 0;
/**
 * Color Palette
 *
...
exports.designTokens = {
    // Background colors
    background: {
        primary: exports.colorPalette.neutral.white,
        secondary: exports.colorPalette.neutral.offWhite,
        tertiary: exports.colorPalette.neutral.lightGray,
    },
    // Button styles
    button: {
        primary: {
            bg: exports.colorPalette.softBlue.primary,
            bgHover: exports.colorPalette.softBlue.secondary,
            text: exports.colorPalette.neutral.white,
        },
        secondary: {
            bg: exports.colorPalette.neutral.lightGray,
            bgHover: exports.colorPalette.neutral.mediumLightGray,
            text: exports.colorPalette.softBlue.primary,
        },
        disabled: {
            bg: exports.colorPalette.neutral.mediumLightGray,
            text: exports.colorPalette.neutral.lightBorderGray,
        },
    },
    // Card and surface styles
    card: {
        bg: exports.colorPalette.neutral.white,
        border: exports.colorPalette.neutral.lightBorderGray,
    ...
    text: {
        ...
        secondary: "#5F6368",
        tertiary: "#70757A",
        inverse: exports.colorPalette.neutral.white,
    },
    // Border colors
    border: {
        light: exports.colorPalette.neutral.lightBorderGray,
        medium: exports.colorPalette.neutral.mediumLightGray,
    },
    // State colors
    state: {
        success: exports.colorPalette.accent.success,
        warning: exports.colorPalette.accent.warning,
        error: exports.colorPalette.accent.error,
        info: exports.colorPalette.accent.info,
    },
};
