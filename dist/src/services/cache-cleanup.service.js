...
exports.cacheCleanupService = exports.CacheCleanupService = void 0;
...
class CacheCleanupService {
    ...
    async cleanup() {
        try {
            ...
            const currentVersions = Object.values(cache_version_1.CACHE_VERSION);
            ...
            do {
                ...
                if (keysToDelete.length > 0) {
                    ...
                    console.log(`[CacheCleanup] Deleted ${keysToDelete.length} old cache keys`);
                }
            } while (cursor !== "0");
            if (totalDeleted > 0) {
                console.log(`[CacheCleanup] Total deleted: ${totalDeleted} old cache keys`);
            }
            else {
...
exports.CacheCleanupService = CacheCleanupService;
