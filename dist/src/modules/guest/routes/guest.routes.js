 ...
 */
guestRouter.get("/search", auth_middleware_1.authMiddleware, guest_controller_1.searchContacts);
/**
 * POST /api/guests/add
 *
 ...
 */
guestRouter.post("/add", auth_middleware_1.authMiddleware, guest_controller_1.addGuest);
/**
 ...
 */
guestRouter.delete("/:guestId", auth_middleware_1.authMiddleware, guest_controller_1.removeGuest);
/**
 ...
 */
guestRouter.patch("/:guestId/permission", auth_middleware_1.authMiddleware, guest_controller_1.updateGuestPermission);
/**
 ...
 */
guestRouter.get("/events/:eventId", auth_middleware_1.authMiddleware, guest_controller_1.getEventGuests);
