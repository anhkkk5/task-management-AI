...
exports.validateSearchContactsMiddleware = exports.validateUpdatePermissionMiddleware = exports.validateAddGuestMiddleware = exports.validateSearchContactsQuery = exports.validateUpdatePermissionRequest = exports.validateAddGuestRequest = exports.validatePaginationParams = exports.validateSearchTerm = exports.getValidPermissions = exports.validatePermission = exports.normalizeEmail = exports.validateEmailFormat = void 0;
/**
...
exports.getValidPermissions = getValidPermissions;
/**
 ...
 * }) // { valid: true, errors: [] }
 */
const validateAddGuestRequest = (body) => {
    const errors = [];
    // Validate eventId
    if (!body?.eventId ||
    ...
    else if (!(0, exports.validateEmailFormat)(body.email)) {
        errors.push({
            field: "email",
    ...
    if (body?.permission !== undefined && body.permission !== null) {
        if (!(0, exports.validatePermission)(body.permission)) {
            errors.push({
                field: "permission",
...
exports.validateAddGuestRequest = validateAddGuestRequest;
/**
 ...
 * // { valid: true, errors: [] }
 */
const validateUpdatePermissionRequest = (body) => {
    const errors = [];
    // Validate permission
    if (body?.permission === undefined || body.permission === null) {
        errors.push({
    ...
    else if (!(0, exports.validatePermission)(body.permission)) {
        errors.push({
            field: "permission",
            message: `Permission must be one of: ${VALID_PERMISSIONS.join(", ")}`,
            value: body.permission,
...
exports.validateUpdatePermissionRequest = validateUpdatePermissionRequest;
/**
 ...
 */
const validateSearchContactsQuery = (query) => {
    // Validate search term
    const searchTermValidation = (0, exports.validateSearchTerm)(query?.q);
    ...
    // Validate pagination parameters
    const paginationValidation = (0, exports.validatePaginationParams)(query?.limit, query?.offset);
    ...
    return {
        valid: true,
        searchTerm: query.q.trim(),
        limit: paginationValidation.limit,
        offset: paginationValidation.offset,
    };
};
exports.validateSearchContactsQuery = validateSearchContactsQuery;
/**
 ...
 */
const validateAddGuestMiddleware = (req, res, next) => {
    const validation = (0, exports.validateAddGuestRequest)(req.body);
    if (!validation.valid) {
        res.status(400).json({
            success: false,
...
exports.validateAddGuestMiddleware = validateAddGuestMiddleware;
/**
 ...
 */
const validateUpdatePermissionMiddleware = (req, res, next) => {
    const validation = (0, exports.validateUpdatePermissionRequest)(req.body);
    if (!validation.valid) {
        res.status(400).json({
            success: false,
            error: "Validation failed",
...
exports.validateUpdatePermissionMiddleware = validateUpdatePermissionMiddleware;
/**
 ...
 */
const validateSearchContactsMiddleware = (req, res, next) => {
    const validation = (0, exports.validateSearchContactsQuery)(req.query);
    if (!validation.valid) {
        res.status(400).json({
            success: false,
...
exports.validateSearchContactsMiddleware = validateSearchContactsMiddleware;
